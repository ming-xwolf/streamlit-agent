...
def get_chat_model(callbacks: Callbacks = None, model_name: str = model_name, base_url: str = base_url,
                   streaming: bool = False) -> ChatOllama:
...
def get_embedding_model():
    return OllamaEmbeddings(base_url=base_url, model=embedding_model_name)
